...
#define DXTRACE_MSG(str)              DXTraceW( __FILE__, (DWORD)__LINE__, 0, str, FALSE )
#define DXTRACE_ERR(str,hr)           DXTraceW( __FILE__, (DWORD)__LINE__, hr, str, FALSE )
#define DXTRACE_ERR_MSGBOX(str,hr)    DXTraceW( __FILE__, (DWORD)__LINE__, hr, str, TRUE )
#else
