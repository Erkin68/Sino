...
extern void (__cdecl *m_VectorF_add_VectorF)(float*, float*, float*);
extern void (__cdecl *m_VectorF_sub_VectorF)(float*, float*, float*);
extern void (__cdecl *m_VectorF_x_VectorF)(float*, float*, float*);
extern void (__cdecl *m_VectorF_div_VectorF)(float*, float*, float*);
extern void (__cdecl *m_VectorF_x_F32)(float*, float*, float);
extern void (__cdecl *m_VectorF_add_F32)(float*, float*, float);
extern void (__cdecl *m_VectorF_sub_F32)(float*, float*, float);
extern void (__cdecl *m_VectorF_div_F32)(float*, float*, float);
extern void (__cdecl *m_VectorF_setMax)(float*, float*, float*);
extern void (__cdecl *m_VectorF_setMin)(float*, float*, float*);
...
NX_INLINE void NxVec3::max(const NxVec3 & v)
	...
	//y = NxMath::max(y, v.y);
	//z = NxMath::max(z, v.z);
	m_VectorF_setMax((float*)this, (float*)this, (float*)&v.x);
	}
...
NX_INLINE void NxVec3::min(const NxVec3 & v)
	...
	//y = NxMath::min(y, v.y);
	//z = NxMath::min(z, v.z);
	m_VectorF_setMin((float*)this, (float*)this, (float*)&v.x);
	}
...
NX_INLINE void  NxVec3::add(const NxVec3 & a, const NxVec3 & b)
	...
	//y = a.y + b.y;
	//z = a.z + b.z;
	m_VectorF_add_VectorF((float*)this, (float*)&a.x, (float*)&b.x);
	}
...
NX_INLINE void  NxVec3::subtract(const NxVec3 &a, const NxVec3 &b)
	...
	//y = a.y - b.y;
	//z = a.z - b.z;
	m_VectorF_sub_VectorF((float*)this, (float*)&a.x, (float*)&b.x);
	}
...
NX_INLINE void  NxVec3::arrayMultiply(const NxVec3 &a, const NxVec3 &b)
	...
	//y = a.y * b.y;
	//z = a.z * b.z;
	m_VectorF_x_VectorF((float*)this, (float*)&a.x, (float*)&b.x);
	}
...
NX_INLINE void  NxVec3::multiply(NxReal s,  const NxVec3 & a)
	...
	//y = a.y * s;
	//z = a.z * s;
	m_VectorF_x_F32((float*)this, (float*)&a.x, s);
	}
...
NX_INLINE void  NxVec3::multiplyAdd(NxReal s, const NxVec3 & a, const NxVec3 & b)
	...
	//z = s * a.z + b.z;
	m_VectorF_x_F32((float*)this, (float*)&a.x, s);
	m_VectorF_add_VectorF((float*)this, (float*)this, (float*)&b.x);
	}
...
NX_INLINE NxReal NxVec3::normalize()
	...
	if (m)
		...
		//y *= il;
		//z *= il;
		m_VectorF_x_F32((float*)this, (float*)this, il);
		}
	return m;
	}
...
NX_INLINE void NxVec3::setMagnitude(NxReal length)
	...
	if(m)
		...
		//y *= newLength;
		//z *= newLength;
		m_VectorF_x_F32((float*)this, (float*)this, newLength);
		}
	}
...
NX_INLINE NxVec3& NxVec3::operator +=(const NxVec3& v)
	...
	//y += v.y;
	//z += v.z;
	m_VectorF_add_VectorF((float*)this, (float*)this, (float*)&v.x);
	return *this;
	}
...
NX_INLINE NxVec3& NxVec3::operator -=(const NxVec3& v)
	...
	//y -= v.y;
	//z -= v.z;
	m_VectorF_sub_VectorF((float*)this, (float*)this, (float*)&v.x);
	return *this;
	}
...
NX_INLINE NxVec3& NxVec3::operator *=(NxReal f)
	...
	//y *= f;
	//z *= f;
	m_VectorF_x_F32((float*)this, (float*)this, f);
	return *this;
	}
